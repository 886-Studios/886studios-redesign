...
export const siteContent = {
  ...
  about: {
    ...
    partners: [
      ...
      { initials: "JH", name: "Joseph Hei", company: "Twitch, Metatheory", photo: "/assets/headshots/joseph-hei.webp" },
      { initials: "CH", name: "Charles Huang", company: "Guitar Hero, Kabam", photo: "/assets/headshots/charles-huang.webp" },
      { initials: "JH", name: "Jameson Hsu", company: "Kabam", photo: "/assets/headshots/jameson-hsu.webp" },
      ...
      { initials: "SC", name: "Steven Chiang", company: "Orbit Baby", photo: "/assets/headshots/steven-chiang.webp" },
